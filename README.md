...
<ul>
  ...
  <li><a href="https://github.com/FranBejarano/dalle-clone" target="_blank"><strong>Dall-E Clone: </strong></a> This project is a web application that generates and manipulates images based on textual prompts. It utilizes the OpenAI API to create images and variations using natural language descriptions.</li>
</ul>
</p>
